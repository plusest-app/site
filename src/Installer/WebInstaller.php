 ...
 * ---------------------------------------
 * Забір фіда й завантаження кількох сотен фотографій триває довше, ніж
...
class WebInstaller
{
    ...
    private function stepForm(array $values, array $errors = [])
    {
        ...
        // --- Фід ------------------------------------------------------------
        $body .= $this->section(
            'Посилання на JSON-feed',
            'Перейдіть в '
            . '<a href="https://plusest.app/cabinet/company/integrations/" target="_blank">інтеграцію компанії</a>'
            . ' в Plusest та активуйте інтеграцію "JSON-feed для сайту компанії". '
            . 'Скопіюйте посилання на JSON-feed та вставте в поле. '
    ...
    private function validate(array $values)
    {
        ...
        if ($values['feedUrl'] === '') {
            $problems[] = 'Не заповнене посилання на JSON-feed з CRM.';
