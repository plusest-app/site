 ...
 *
 * День тижня і година беруться через date(), тобто в поясі, який Config
 * встановлює з налаштування timezone. Це важливо: поки пояс брався з php.ini
 * (а в CLI це зазвичай UTC), вікно «з 8 до 21» насправді припадало на інші
 * години, і ранкове звернення потрапляло в нічний інтервал — наступне було
 * не за дві години, а після відкриття вікна.
 *
